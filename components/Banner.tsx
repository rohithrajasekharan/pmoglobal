    ...
    >
      <div className="h-screen">
        <nav className="py-4 flex justify-between items-center bg-black bg-opacity-50 px-[10%]">
          <ul className="flex flex-wrap items-center space-x-2 lg:space-x-4 text-white">
            <li>
        ...
        <div className="flex items-center h-screen">
          <div className="container flex flex-col items-start space-y-4 mx-[10%] sm:mx-[5%] md:mx-[10%] lg:mx-[10%] pb-4">
            <div className="bg-black bg-opacity-50 text-white px-2 py-1 rounded text-sm lg:text-base border-l-4 border-red-600">
